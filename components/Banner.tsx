...
export const Banner = () => {
  return (
    <section
      id="home"
      className="max-w-contentContainer mx-auto py-10 mdl:py-24 flex flex-col md:flex-row-reverse justify-center items-center gap-4 lgl:gap-8 mdl:gap-10 xl:gap-4 text-center"
    >
      <motion.div
      ...
      <div>
        ...
        <motion.p
          ...
          className="text-base mdl:max-w-[650px] font-medium text-textDark mx-auto my-5 "
        >
